...
/**
 * Staff-only stock and price editor — gated behind the "Manage stock" drawer
 * row, which only renders for role === 'staff' | 'admin' (see DrawerMenu).
 * The backend independently enforces the same check on every endpoint here,
 * so this screen being reachable is never itself the security boundary.
 */
